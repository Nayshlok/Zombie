...
namespace CedenoB_ZombieGame.UnitMovement
{
    class Movement
    {
        ...
        List<Square> characterList = new List<Square>();
        ...
        */ //Give Item
        ...
        public bool checkLineOfSight(int[] target, int[] currentLocation)
        {
            ...
            //if (xSquaresToMove == 0 && ySquaresToMove == 0)
            //{
            //    //Console.WriteLine(((Zeds)player).t + " at [" + currentLocation[0] + ", " + currentLocation[1] + "] Requested to\n move to [" + target[0] + ", " + target[1] + "] and was granted the movement \n\n");
            ...
            //    if (1 == 0)
            //    {
            //        //Console.WriteLine(((Zeds)player).t + " at [" + currentLocation[0] + ", " + currentLocation[1] + "] Requested to\nmove to [" + target[0] + ", " + target[1] + "] and was denied due to lack of squares possible per turn");
