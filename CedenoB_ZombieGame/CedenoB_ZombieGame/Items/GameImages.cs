...
namespace CedenoB_ZombieGame.Model
{
  ...
  {
      //Classes
      public static BitmapImage WarriorSource = new BitmapImage(new Uri("Images/War.png", UriKind.Relative));
      public static BitmapImage SurvivalistSource = new BitmapImage(new Uri("Images/Sur.png", UriKind.Relative));
      public static BitmapImage SharpShooterSource = new BitmapImage(new Uri("Images/SharpShooter.png", UriKind.Relative));
